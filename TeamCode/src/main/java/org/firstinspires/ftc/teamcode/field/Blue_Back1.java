...
public class Blue_Back1 {

    public static final Pose START_POSE   = new Pose(56, 8, Math.toRadians(90));

    // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    public static final Pose SCORE_POSE   = new Pose(33, 37, Math.toRadians(120));
    ...
    // Middle (2nd Set) of Artifacts from the Spike Mark.
    public static final Pose ALIGN2_POSE  = new Pose(33, 12, Math.toRadians(0));
    public static final Pose PICKUP2_POSE = new Pose(33, 11, Math.toRadians(0));

    // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose ALIGN3_POSE  = new Pose(33, 10, Math.toRadians(0));
    public static final Pose PICKUP3_POSE = new Pose(33, 10, Math.toRadians(0));
