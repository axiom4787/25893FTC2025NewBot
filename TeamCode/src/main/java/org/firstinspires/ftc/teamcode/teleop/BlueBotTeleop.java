...
public class BlueBotTeleop extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    // Does this move the robot? not anymore but you need to init the wrist or press b to get it to
    ...
    while (opModeIsActive()) {
       ...
       * consideration the drive speed and the value of the right joystick x-axis. Multiplying by -1
       * is because smaller numbers of steering_angle are on the right side whereas -1 is on the
       * left side of the x-axis joystick.
       */
...
//        amazingSwerve.odometry.resetHeading(new Rotation2d());
      ...
      */
      ...
      double g2_lx = gamepad2.left_stick_x,
      ...
      telemetry.addLine(
          "Slider current pos: "
              + mek.arm.slide.getCurrentPosition()
              + "Slide goal pos: "
              + mek.arm.slide.getTargetPosition());
      ...
      if (game2B) mek.grabber.setWrist(1.0);
