...
// The same as Shared, but accounting for a field width of 141.5 instead of 144.
public class Shared2 {
    ...
    public static void setAlliance(@NotNull Alliance alliance) {
        if (Shared2.alliance != alliance) mirror();

        Shared2.alliance = alliance;
    }

    private static void mirror() {
        final double FIELD_WIDTH = 141.5;
