...
public class April_Sensor {

  // Default constructor
  public April_Sensor(LinearOpMode opmode) {
    myOp = opmode;
  }
  ...
  /**
   * Methods for distance and angle to the tag From a known april tag location provides reference to
   * field orientation Back project to center of field - - -
   */
