...
public class Solo12Ball extends CommandOpModeWithAlliance {
    ...
    public void buildPaths(Follower follower) {
        ...
        row2ToScore = follower.pathBuilder()
                .addPath(new BezierLine(Shared.Artifacts.ROW_2_END, m(new Pose(125, Shared.Artifacts.Y_2))))
                .setConstantHeadingInterpolation(Shared.Artifacts.INTAKE_HEADING)
                .addPath(new BezierCurve(m(new Pose(125, Shared.Artifacts.Y_2)), m(new Pose(110, Shared.Artifacts.Y_2)), Shared.Close.SCORE_POSE))
                .setLinearHeadingInterpolation(Shared.Artifacts.INTAKE_HEADING, Shared.Close.SCORE_POSE.getHeading())
                .build();

        scoreToIntakeRow3 = follower.pathBuilder()
                .addPath(new BezierCurve(Shared.Close.SCORE_POSE, m(new Pose(90, 35.5)), Shared.Artifacts.ROW_3_START))
                .setLinearHeadingInterpolation(Shared.Close.SCORE_POSE.getHeading(), Shared.Artifacts.INTAKE_HEADING)
                .addPath(new BezierLine(Shared.Artifacts.ROW_3_START, Shared.Artifacts.ROW_3_END))
                .setConstantHeadingInterpolation(Shared.Artifacts.INTAKE_HEADING)
                .build();

        row3ToScore = follower.pathBuilder()
                .addPath(new BezierLine(Shared.Artifacts.ROW_3_END, Shared.Close.SCORE_POSE))
                .setLinearHeadingInterpolation(Shared.Artifacts.INTAKE_HEADING, Shared.Close.SCORE_POSE.getHeading())
                .build();
