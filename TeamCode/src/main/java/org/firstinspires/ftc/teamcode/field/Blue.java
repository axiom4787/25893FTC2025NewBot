...
public class Blue {
    ...
    public static final Pose SCORE_POSE   = new Pose(50, 37, Math.toRadians(120));
    ...
    public static final Pose ALIGN2_POSE  = new Pose(50, 37, Math.toRadians(0));
    public static final Pose PICKUP2_POSE = new Pose(50, 38, Math.toRadians(0));

    // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose ALIGN3_POSE  = new Pose(50, 38, Math.toRadians(0));
    public static final Pose PICKUP3_POSE = new Pose(50, 38, Math.toRadians(0));
